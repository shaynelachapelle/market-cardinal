          ...
          {results.map((item, index) => (
            ...
            >
              <span className="flex flex-row items-center font-semibold">
                <div className="flex w-6 h-6 bg-none mr-3">
                  <img className="rounded-xl" src={fetchLogo(item)} />
                </div>
                <span className="w-20">{item.symbol}</span>
                <span className="truncate max-w-32 md:max-w-none md:whitespace-normal font-normal ml-4">
                  {item.name}
                </span>
              </span>
